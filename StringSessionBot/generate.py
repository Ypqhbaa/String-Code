...
ERROR_MESSAGE = "**- أُووبـس! هنالك خطـأ!** \n\n**الخطـأ هـو -** : {} " \
            "\n\n**- الرجاء التواصل @y2d_3 واعلامه بالخطـأ** " \
...
async def main(_, msg):
    await msg.reply(
        "**- اختـر تليثـون لاستخـراج كـود تيرمكـس هيرثون **",
...
async def generate_session(bot, msg, telethon=False):
    ...
    await msg.reply("**بـدء استخـراج الجلسـه Herthon ⌬....**")
    if telethon:
    ...
    text = "**- كـود تيرمكـس {} Herthon** \n\n{} \n\n**- تم الاستخـراج بواسطـة** @Herthon\n**- تحياتـي ..  المــــؤسّــــس↜ᵐⁿ** @y2d_3 ".format("تليثـون" if telethon else "بايروجـرام", string_session)
    await client.send_message("me", text)
    await client.disconnect()
    await phone_code_msg.reply("**- تم إنشاء جلسة تيرمكس {} Herthon بنجاح ..** \n\n**- يرجى التحقق من حافظـة حسابـك واخذ الكود!**\n\n**- لا تقم بمشاركـة هذا الكود مع احـد ⚠️**\n\n".format("تليثـون" if telethon else "بايروجـرام"))
